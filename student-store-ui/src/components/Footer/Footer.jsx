      ...
      <div className="rowfooter">
        <div className="col-leftFooter">
          <p>
            ...
            <br></br>from a great team and for a great cause.<br></br>
            We've searched far and wide for items that perk the interests{" "}
            <br></br>of even the most eccentric students and decided to offer
            them all<br></br> here in one place.<br></br>
