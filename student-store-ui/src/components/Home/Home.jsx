  ...
  return (
    <div className="home">
        ...
        <div className="col-right">
          <div className="links">
            <ul>
              ...
              <li><button onClick="#" className="button">Home</button></li>
              <li><button onClick="#" className="button">About Us</button></li>
              <li><button onClick="#" className="button">Contact Us</button></li>
              <li><button onClick="#" className="button">Buy Now</button></li>
      ...
      <div className="hero">
        <div className="row">
          <div className="col-right">
            <h1>Welcome!<br></br>Find your Merch!</h1>
            <p>
          ...
          <div className="col-left">
            <img className="heroImage"src="https://codepath-student-store-demo.surge.sh/assets/student_store_icon.18e5d61a.svg" />
          </div>
        </div>
        <p>ii</p>
